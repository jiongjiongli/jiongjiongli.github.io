...
### Global Convergence
Let $X$ be a set and ${\vec{\mathbf {x}}}_{0} \in X$ a given point. Then an algorithm, $\mathcal{A}$ , with initial point ${\vec{\mathbf {x}}}_{0}$ is a point-to-set map which generates a sequence
