...
$\mathcal{A}$ is said to be globally convergent if: For any chosen initial point $\text {} {\mathbf {x}_{0}}$, the sequence
...
$$
\text {}{\mathbf {x}_{t + 1}} \in \mathcal{A} \left (\text {} {\mathbf {x}_{t}} \right )
$$
