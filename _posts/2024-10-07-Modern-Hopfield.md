...
with initial point $\text {} {\mathbf {x}_{0}}$ is a point-to-set map which generates a sequence ${\left \lbrace \text {} {\mathbf {x}_{t}} \right \rbrace} _{t=0} ^{\infty}$ via the rule
